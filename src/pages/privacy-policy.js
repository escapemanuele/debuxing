...
const PrivacyPolicy = ({data}) => {
    return (
        <Layout>
         ...
         <Title title="Privacy Policy of Debuxing" />
         <PolicyWrapper>
            <div>
               <div>
               ...
               <ul class="for_boxes">
                  <li>
                     <div class="box_primary box_10 expand collapsed">
                        <h3 class="expand-click w_icon_24 policyicon_purpose_7081404">Analytics</h3>
                  ...
                  <p>https://debuxing.com uses cookies to store information about visitors' preferences, to record user-specific information on which pages the site visitor accesses or visits, and to personalize or customize our web page content based upon visitors' browser type or other information that the visitor sends via their browser.</p>

DoubleClick DART Cookie

→ Google, as a third party vendor, uses cookies to serve ads on https://debuxing.com.

→ Google's use of the DART cookie enables it to serve ads to our site's visitors based upon their visit to https://debuxing.com and other sites on the Internet.
